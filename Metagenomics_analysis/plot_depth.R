...
### Load sequences:
reference_path = "/home/josemari/Desktop/Jose/Reference_sequences/AAV2"
reference <- read.fasta(paste0(reference_path, "/NC_001401.2.fasta"), as.string = TRUE, forceDNAtolower = TRUE, set.attributes = FALSE)
ref_gff <- read.table(paste0(reference_path, "/NC_001401.2.gff3"), sep = "\t", header = FALSE, stringsAsFactors = FALSE, quote = "")
# Load the dept.txt file.
depth_file_path = "/home/josemari/Desktop/Jose/Projects/AAV2/Data/Irish_Samples/22G58013_65.fastq.gz_results"
id = "22G58013_65"
setwd(depth_file_path)
depth_file <- read.table(paste0(depth_file_path, "/22G58013_65.fastq.gz_depth.txt"),  sep = '\t', header = FALSE)
...
y1 <- 1.5
y2 <- 1.6
draw_rectangle(3000, 3300, y1, y2, "darkred")
text(3150, (y1-0.2), "0-50X", cex = 0.7)
draw_rectangle(3500, 3800, y1, y2, "blue")
text(3650, (y1-0.2), "51-150X", cex = 0.7)
draw_rectangle(4000, 4300, y1, y2, "green")
text(4150, (y1-0.2), ">150X", cex = 0.7)
